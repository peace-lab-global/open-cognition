...
- [系统1与系统2](系统1与系统2.md) — 锚定涉及两种机制：系统1的启动效应和系统2的调整不足
- [启发式与偏差](启发式与偏差.md) — 锚定是最稳健的启发式偏差之一
- [前景理论](前景理论.md) — 锚可被视为一种特殊的参考点
- [可得性启发](可得性启发.md) — 锚通过选择性通达机制激活特定记忆
...
→ 返回 [卡尼曼主页](../../../../../README.md) | 上一个概念：[前景理论](前景理论.md) | 下一个概念：[可得性启发](可得性启发.md)
