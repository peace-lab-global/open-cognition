...
### 3. 三学
**戒·定·慧**（详见 [three-trainings](../core-concepts/three-trainings.md)）是上座部修行的总纲。

### 4. 四果位
预流果 → 一来果 → 不还果 → **阿罗汉果**（解脱的最高果位）

### 5. 三法印
无常（anicca）、苦（dukkha）、无我（anattā）——详见 [three-marks](../core-concepts/three-marks.md)。
...
- [内观禅修](../core-concepts/three-trainings.md) — [下位] 上座部的现代延伸
