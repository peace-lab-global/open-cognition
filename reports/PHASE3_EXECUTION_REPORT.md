...
|--------|------|----------|-----------|-----------|
| 阿底峡 | 藏传噶当派 | `wisdom-masters/masters/tibet/atisha.md` | 菩提道灯引导 | `skills/religion-frameworks/bodhisattva-path-guidance/SKILL.md` |
| 阿姜查 | 南传森林传统 | `wisdom-masters/masters/thailand/ajahn-chah.md` | 森林禅修引导 | `skills/religion-frameworks/forest-meditation-guidance/SKILL.md` |
| 佛使比丘 | 南传佛教 | `wisdom-masters/masters/thailand/buddhadasa.md` | 缘起法分析 | `skills/religion-frameworks/dependent-origination-analysis/SKILL.md` |
...
|--------|------|----------|-----------|-----------|
| 皮亚杰 | 认知发展 | `domains/psychology/schools/developmental/piaget.md` | 认知发展阶段评估 | `skills/psychology-frameworks/cognitive-development-assessment/SKILL.md` |
| 斯金纳 | 行为主义 | `domains/psychology/schools/behaviorism/skinner.md` | 行为强化分析 | `skills/psychology-frameworks/behavior-reinforcement-analysis/SKILL.md` |
| 罗杰斯 | 人本主义 | `domains/psychology/schools/humanistic/rogers.md` | 来访者中心对话 | `skills/psychology-frameworks/client-centered-dialogue/SKILL.md` |
...
| 思想家 | 学派 | 条目路径 | 新增Skill | Skill路径 |
|--------|------|----------|-----------|-----------|
| 涂尔干 | 古典社会学 | `domains/sociology/schools/classical/durkheim.md` | 社会事实分析 | `skills/sociology-frameworks/social-fact-analysis/SKILL.md` |
| 哈贝马斯 | 批判理论 | `domains/sociology/schools/critical/habermas.md` | 交往行为分析 | `skills/sociology-frameworks/communicative-action-analysis/SKILL.md` |
| 鲍曼 | 后现代性 | `domains/sociology/schools/modernity/bauman.md` | 液态现代性分析 | `skills/sociology-frameworks/liquid-modernity-analysis/SKILL.md` |
...
| 思想家 | 学派 | 条目路径 | 新增Skill | Skill路径 |
|--------|------|----------|-----------|-----------|
| 柏拉图 | 古希腊 | `domains/philosophy/schools/ancient-greek/plato.md` | 洞穴寓言分析 | `skills/philosophy-frameworks/allegory-of-cave-analysis/SKILL.md` |
| 亚里士多德 | 古希腊 | `domains/philosophy/schools/ancient-greek/aristotle.md` | 中庸之道分析 | `skills/philosophy-frameworks/golden-mean-analysis/SKILL.md` |
| 尼采 | 存在主义 | `domains/philosophy/schools/existentialism/nietzsche.md` | 权力意志分析 | `skills/philosophy-frameworks/will-to-power-analysis/SKILL.md` |
| 海德格尔 | 现象学 | `domains/philosophy/schools/existentialism/heidegger.md` | 此在分析 | `skills/philosophy-frameworks/dasein-analysis/SKILL.md` |
...
| 组合Skill | 内容 | Skill路径 |
|-----------|------|-----------|
| 佛教-道教对话 | 比较佛教与道教的异同，寻找对话空间 | `skills/religion-frameworks/buddhism-taoism-dialogue/SKILL.md` |
| 东西方伦理对比 | 比较康德、亚里士多德与儒家、道家伦理 | `skills/philosophy-frameworks/east-west-ethics-comparison/SKILL.md` |
