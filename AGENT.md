...
[![Concepts](https://img.shields.io/badge/concepts-110-green.svg)](./domains)
[![Thinkers](https://img.shields.io/badge/thinkers-154-orange.svg)](./domains)

---

## TL;DR — 30 秒接入

1. **找 Skill**：`skills/<domain>-frameworks/<skill-id>/SKILL.md`
...
qodercli skill run skills/psychology-frameworks/cbt-cognitive-distortion/SKILL.md \
  --input "分析这段独白：……"
```
...
│
├── domains/<domain>/                   # 思想家 + 概念条目
│   ├── philosophy/    (28 thinkers / 8 concepts)
│   ├── religion/      (8 thinkers  / 42 concepts) ← 含佛教认知专题
│   ├── sociology/     (18 thinkers / 7 concepts)
│   ├── psychology/    (28 thinkers / 8 concepts)
│   ├── ethics-politics/ (15 / 11)
│   ├── aesthetics/    (23 / 7)
│   ├── literature/    (5 / 0)
│   ├── arts/          (3 / 0)
│   └── cognitive-systems/ (26 / 27)
│
├── skills/<domain>-frameworks/<skill-id>/SKILL.md   # 101 个通用 Skill
│
└── domains/religion/buddhism/concepts/cognitive-theory/   # 🌟 佛教认知专题
    ├── <concept>.md                    # 19 概念
...
### 通用类（在 `skills/<domain>-frameworks/` 下）

| Skill | 用途 | 路径 |
|---|---|---|
| CBT 认知扭曲识别 | 识别 10 类认知扭曲并重构 | [cbt-cognitive-distortion](./skills/psychology-frameworks/cbt-cognitive-distortion/SKILL.md) |
| 布迪厄场域分析 | 分析权力/资本/惯习结构 | [bourdieu-field-analysis](./skills/sociology-frameworks/bourdieu-field-analysis/SKILL.md) |
| 四圣谛诊断 | 用佛教诊断框架看具体困境 | [four-noble-truths-framework](./skills/religion-frameworks/four-noble-truths-framework/SKILL.md) |
| 康德先验分析 | 追问经验的可能条件 | [kant-transcendental](./skills/philosophy-frameworks/kant-transcendental/SKILL.md) |
| STPA 事故分析 | 系统理论事故分析 | [stpa-accident-analysis](./skills/cognitive-systems-frameworks/stpa-accident-analysis/SKILL.md) |

### 佛教认知专题类（在 `domains/religion/buddhism/concepts/cognitive-theory/skills/` 下）

| Skill | 用途 | 路径 |
|---|---|---|
| 八识认知诊断 | 定位认知卡点在哪一识 | [eight-consciousness-diagnosis](./domains/religion/buddhism/concepts/cognitive-theory/skills/eight-consciousness-diagnosis/SKILL.md) |
| 三性诊断 | 剥离叙事，看见缘起事实 | [three-natures-diagnosis](./domains/religion/buddhism/concepts/cognitive-theory/skills/three-natures-diagnosis/SKILL.md) |
| 种子模式分析 | 追溯认知惯性的熏习来源 | [bija-pattern-analysis](./domains/religion/buddhism/concepts/cognitive-theory/skills/bija-pattern-analysis/SKILL.md) |
| 量论三量验证 | 评估认知的有效性来源 | [pramana-validation](./domains/religion/buddhism/concepts/cognitive-theory/skills/pramana-validation/SKILL.md) |
| 二谛重构 | 在冲突陈述间切换世俗/胜义视角 | [two-truths-reframing](./domains/religion/buddhism/concepts/cognitive-theory/skills/two-truths-reframing/SKILL.md) |
| 五蕴解构 | 把实体化"我"解构为过程束 | [five-aggregates-deconstruction](./domains/religion/buddhism/concepts/cognitive-theory/skills/five-aggregates-deconstruction/SKILL.md) |
| 缘起链追溯 | 逆向追溯困境的 12 支生成链 | [dependent-origination-tracing](./domains/religion/buddhism/concepts/cognitive-theory/skills/dependent-origination-tracing/SKILL.md) |

完整列表见 [佛教认知专题 README](./domains/religion/buddhism/concepts/cognitive-theory/README.md) 的"认知地图"表。
...
# 在对话中调用
qodercli chat --skills-dir skills/
```
...
find domains skills -name "*.md" -not -name "README.md" -not -name "INDEX.md" \
...
```json
{
  "path": "domains/religion/buddhism/concepts/cognitive-theory/pramana.md",
  "id": "pramana",
  "title": "量论 · Pramāṇa",
  "type": "concept",
  "domain": "religion",
...
- [meta/templates/](./meta/templates/) — 思想家/概念/学派/Skill 模板
- [meta/quality-criteria.md](./meta/quality-criteria.md) — 质量标准
- [domains/religion/buddhism/INDEX.md](./domains/religion/buddhism/INDEX.md) — 佛教认知专题导航
